...
//          tuesday-2
        HashMap<Date, String> getDates0 = CalculateDates.calculateRecyclingDates( 0, 3, "waste", "recycling glass");
...
//        thursday-1a
        HashMap<Date, String> getDates1 = CalculateDates.calculateRecyclingDates(0, 5, "recycling", "waste glass");
...
//        friday-2
        HashMap<Date, String> getDates2 = CalculateDates.calculateRecyclingDates( 0, 6, "waste", "recycling glass");
...
//        friday-1
        HashMap<Date, String> getDates3 = CalculateDates.calculateRecyclingDates( 0, 6, "recycling glass", "waste");
...
//          wednesday-2
        HashMap<Date, String> getDates4 = CalculateDates.calculateRecyclingDates(0, 4, "waste", "recycling glass");
...
//        thursday-1
        HashMap<Date, String> getDates5 = CalculateDates.calculateRecyclingDates( 0, 5, "recycling glass", "waste");
...
//        tuesday-1
        HashMap<Date, String> getDates6 = CalculateDates.calculateRecyclingDates( 0, 3, "recycling glass", "waste");
...
//        wednesday-1a
        HashMap<Date, String> getDates7 = CalculateDates.calculateRecyclingDates( 0, 4, "recycling", "waste glass");
...
//        friday-1a
        HashMap<Date, String> getDates8 = CalculateDates.calculateRecyclingDates( 0, 6, "recycling", "waste glass");
...
//        thursday-2
        HashMap<Date, String> getDates9 = CalculateDates.calculateRecyclingDates( 0, 5, "waste", "recycling glass");
...
//        wednesday-1
        HashMap<Date, String> getDates10 = CalculateDates.calculateRecyclingDates( 0, 4, "recycling glass", "waste");
...
//        tuesday-1a
        HashMap<Date, String> getDates11 = CalculateDates.calculateRecyclingDates( 0, 3, "recycling", "waste glass");
